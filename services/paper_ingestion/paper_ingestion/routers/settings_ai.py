...
# Anchor to repo root: this file lives at
#   services/paper_ingestion/paper_ingestion/routers/settings_ai.py
# parents[0] = routers/, parents[1] = paper_ingestion/, parents[2] = paper_ingestion/ (pkg),
# parents[3] = services/, parents[4] = repo root
_REPO_ROOT = Path(__file__).resolve().parents[4]
_CONFIG_PATH = _REPO_ROOT / "config" / "llm-tier-candidates.yaml"
