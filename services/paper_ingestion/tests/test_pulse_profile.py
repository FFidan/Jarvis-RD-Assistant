...
from tests.pulse_helpers import fake_embedding_vector
...
# ---------------------------------------------------------------------------
# M11 — weight clamping (D2-02: moved from test_pulse_profile_clamp.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# H20 / WS-6C — user_id filtering (D2-02: moved from test_pulse_profile_user_id.py)
# ---------------------------------------------------------------------------
