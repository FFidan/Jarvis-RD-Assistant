...
_TEST_API_KEY = "auth-contract-key-phase-b-do-not-use-in-prod"
...
def _make_unauthenticated_client(app) -> httpx.AsyncClient:
    """Client with X-API-Key but NO session cookie — for auth bootstrap endpoints."""
