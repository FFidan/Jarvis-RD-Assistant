...
from app.models import CardResponse, DeckResponse, Evidence
...
def row_to_card_response(row) -> CardResponse:
    ...
    evidence = Evidence(**evidence_raw) if evidence_raw is not None and isinstance(evidence_raw, dict) else None
