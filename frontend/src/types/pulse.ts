...
export interface PulseDeck {
  ...
  generated_at: string;
  cards: PulseCardItem[];
  stats: { source_diagnostics?: Record<string, PulseSourceDiagnostic> };
  degraded_reason?: string | null;
  is_stale?: boolean;
  stale_age_days?: number | null;
  stale_diagnostics?: Record<string, PulseStaleDiagnostic> | null;
  empty_reason?: string | null;
}

export interface PulseStaleDiagnostic {
