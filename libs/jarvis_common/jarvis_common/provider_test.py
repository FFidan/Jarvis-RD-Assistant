"""Provider connectivity probes for cloud LLM credentials."""
...
class ProviderTestResult(BaseModel):
    ...
    ----------
    ok : bool
        Whether the provider accepted the supplied connection settings.
    error : str or None, optional
        Bounded failure detail suitable for an administrator response.
    """
