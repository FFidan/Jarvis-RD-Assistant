...
# can reach it at https://<this-machine-ip>:3001
...
YAML
    ...
    if [ -n "$LAN_IP" ]; then
      ...
      ok "Detected LAN IP: ${LAN_IP} (will be added to CORS_ORIGINS)."
    else
      warn "Could not auto-detect LAN IP — you may need to edit CORS_ORIGINS in .env to add your machine's IP."
    fi
    ;;
  3)
