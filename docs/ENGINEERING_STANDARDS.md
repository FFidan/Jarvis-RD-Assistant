...
- [PRD.md](https://github.com/FFidan/Jarvis-RD-Assistant/blob/main/docs/PRD.md) - product requirements behind user-facing behavior.
...
anti-patterns are governed by [docs/contracts/07-testing.md](https://github.com/FFidan/Jarvis-RD-Assistant/blob/main/docs/contracts/07-testing.md)
...
- New tests MUST conform to one of the four legitimate shapes (pure-function
  ...
  [scripts/check-test-shape.py](https://github.com/FFidan/Jarvis-RD-Assistant/blob/main/scripts/check-test-shape.py) on every commit.
