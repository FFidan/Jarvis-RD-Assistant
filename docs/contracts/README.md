...
- [docs/specs/2026-04-29-paper-lifecycle-redesign.md](../specs/2026-04-29-paper-lifecycle-redesign.md) — recent atomic-cutover spec; the lifecycle schema referenced by 01-settings.md
- [docs/specs/2026-05-02-instructor-langfuse-integration.md](../specs/2026-05-02-instructor-langfuse-integration.md) — B.1+B.2 implementation spec; transitional counterpart to 03-llm.md and 04-observability.md
- [docs/plans/2026-04-30-marathon-meta.md](../plans/2026-04-30-marathon-meta.md) — multi-phase modernization roadmap
